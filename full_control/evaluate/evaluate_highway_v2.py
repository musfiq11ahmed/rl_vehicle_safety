...
from full_control.envs.highway_config_v2 import make_highway_env
...
fig.suptitle("PPO Agent Evaluation — HighwayEnv V2", 
...
plt.savefig("experiments/highway_evaluation_v2.png", dpi=150, 
            bbox_inches='tight')
plt.show()
print("\nEvaluation plots saved to experiments/highway_evaluation_v2.png")